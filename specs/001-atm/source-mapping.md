...
|----------|------------|-------|----------|
| Health endpoint returns OK | `main.py` | 13-15 | `health_check` |
| Successfully create a new account | `routes/accounts.py` | 25-38 | `create_account` |
...
| Response does not include PIN field | `routes/accounts.py` | 18-22 | `create_account` |
...
| Empty holder name accepted | `routes/accounts.py` | 12-15 | `create_account` |
| Successfully retrieve balance | `routes/accounts.py` | 41-43 | `get_balance` |
...
| Retrieve transaction history for an account | `routes/accounts.py` | 48-52 | `get_history` |
| Transactions are ordered newest first | `routes/accounts.py` | 51 | `get_history` |
...
| All transactions returned without pagination | `routes/accounts.py` | 48-52 | `get_history` |
| Successful deposit increases balance | `routes/transactions.py` | 25-38 | `deposit` |
...
| Successful withdrawal decreases balance | `routes/transactions.py` | 41-57 | `withdraw` |
...
| `routes/accounts.py` | 3 (`create_account`, `get_balance`, `get_history`) | 14 | 100% |
| `routes/transactions.py` | 3 (`deposit`, `withdraw`, `transfer`) | 20 | 100% |
| `auth.py` | 1 (`verify_pin`) | 11 | 100% |
...
|------|----------|-------|--------|
| `database.py` | `get_db` | 14-19 | Internal infrastructure: FastAPI dependency injection session factory. Exercised implicitly by all DB-dependent endpoints. |
| `models.py` | `Account` (class) | 15-25 | ORM model declaration. Covered implicitly through endpoint tests. |
| `models.py` | `Transaction` (class) | 28-39 | ORM model declaration. Covered implicitly through endpoint tests. |
| `models.py` | `TransactionType` (enum) | 9-12 | Enum declaration. Used by transaction endpoints; no standalone behavior. |
...
All uncovered items are infrastructure or declarative — no behavioral logic left uncovered.
