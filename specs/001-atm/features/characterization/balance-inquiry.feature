...
Feature: Balance Inquiry
  Account holders can check their account balance.

  Background:
    Given an account exists with account_number "ACC001", holder_name "Alice", pin "1234", and balance 500.00

  @characterization @extracted @source:routes/accounts.py:41-43 @criterion:AC-003-01 @confidence:high
  ...
  @characterization @extracted @source:auth.py:8 @criterion:AC-003-02 @confidence:high
  ...
  @characterization @extracted @source:auth.py:15-16 @criterion:AC-003-03 @confidence:high
