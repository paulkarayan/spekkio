...
Feature: Withdraw Funds
  ...
  @characterization @extracted @source:routes/transactions.py:42-57 @criterion:AC-006-01 @confidence:high
  ...
  Scenario: Withdrawal creates a transaction record
    ...
    And the transaction description should be "Withdrawal of $100.00"

  @characterization @extracted @source:routes/transactions.py:45 @criterion:AC-006-01 @confidence:high @anomaly @needs-review
  # ANOMALY: No withdrawal limit per transaction or per day.
